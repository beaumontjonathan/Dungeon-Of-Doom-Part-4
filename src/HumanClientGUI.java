...
public class HumanClientGUI extends JFrame {
    ...
    public HumanClientGUI(HumanClientController controller) {
        ...
        //HumanClientConnectGUI connectToServerGUI = new HumanClientConnectGUI(controller);

    }

    public static void main(String[] args) {
        new HumanClientController(args);
    }
    ...
    private JPanel getChatBar() {
        ...
        chatBoxScrollPane.setPreferredSize(new Dimension(200, 100));
    ...
    public synchronized void instantiateMapGrid(int width) {
        mapGrid = new MapGrid(width, width, ICON_SIZE);
    }
